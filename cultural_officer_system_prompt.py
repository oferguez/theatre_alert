...
When triggered, return a curated list of **relevant cultural events happening in London from {today_str} to {end_date_str}**. Include:
...
Keep the list under 15 entries and order by date. Use elegant, concise tone. End with a short suggestion for something the user might not expect but could love.
"""
